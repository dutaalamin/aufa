...
export default function Footer() {
  return (
    <footer className="bg-charcoal-deep py-12 relative overflow-hidden">
      ...
      <div className="w-full px-6 md:px-12 relative z-10 flex flex-col space-y-6">
        ...
        <div className="flex items-center gap-4 text-slate-400">
          ...
          {/* Email */}
          <a href="mailto:hello@aufastudio.com" className="hover:text-white transition-colors">
            <svg className="h-[15px] w-[15px] fill-current" viewBox="0 0 24 24">
