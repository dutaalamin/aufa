...
export default function Contact() {
  ...
  return (
    <section 
      id="contact" 
      className="relative py-24 md:py-32 bg-charcoal-dark border-b border-white/5 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            ...
            <div className="space-y-6 font-sans text-xs md:text-sm text-slate-400 font-light">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:hello@aufastudio.com" className="text-slate-300 hover:text-gold transition-colors block">
                    hello@aufastudio.com
                  </a>
                  <a href="mailto:press@aufastudio.com" className="text-slate-500 hover:text-gold transition-colors block text-xs mt-0.5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+62361765432" className="text-slate-300 hover:text-gold transition-colors block">
                    +62 361 765 432
                  </a>
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex items-center gap-3">
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer"
                  className="p-3 bg-charcoal-deep border border-white/5 hover:border-gold hover:text-gold text-slate-400 transition-colors"
                >
          ...
          <div className="lg:col-span-7 bg-charcoal-deep/30 border border-white/5 p-8 md:p-12 relative overflow-hidden">
            
            {/* Outline accent lines */}
            <div className="absolute top-0 right-0 w-16 h-[1px] bg-gold/10" />
            <div className="absolute top-0 right-0 w-[1px] h-16 bg-gold/10" />

            {submitted ? (
              <div className="h-[350px] flex flex-col items-center justify-center text-center space-y-4">
                <div className="w-12 h-12 rounded-full border border-gold flex items-center justify-center text-gold animate-pulse">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-charcoal-deep border border-white/10 px-4 py-3 text-xs text-white focus:outline-none focus:border-gold transition-colors rounded-none placeholder:text-slate-600"
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    className="w-full bg-charcoal-deep border border-white/10 px-4 py-3 text-xs text-slate-300 focus:outline-none focus:border-gold transition-colors rounded-none"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-charcoal-deep border border-white/10 px-4 py-3 text-xs text-white focus:outline-none focus:border-gold transition-colors rounded-none placeholder:text-slate-600 resize-none"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="group w-full py-4 bg-transparent border border-gold/40 hover:border-gold text-white hover:text-charcoal-deep font-display text-xs uppercase tracking-widest transition-all duration-500 overflow-hidden relative"
                >
